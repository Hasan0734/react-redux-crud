        ...
        <>
             <form onSubmit={handleSubmit} style={{ width: '350px' }}>
                    <div className='my-3'>
                        ...
                        <input required defaultValue={state.name} onChange={(e) => setName(e.target.value)} className='form-control' type="text" placeholder='Name' id='book_name' />
                    </div>
                    <div className='my-3'>
                        <label className='form-label' htmlFor="author_name">Author Name</label>
                        <input required defaultValue={state.author}onChange={(e) => setAuthor(e.target.value)} className='form-control' type="text" placeholder='Author' id='author_name' />
                    </div>
